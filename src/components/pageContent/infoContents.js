export const infoContents = [
    ...
    },
    {
        ...
        list: [
            "The killer App, powered by Orama Engine. The brain behind all the master creations, now at the users disposal.",
            "Highly effective production tool for creative professionals. Greatly improve the efficiency of traditional art/design creation process.",
    ...
    {
        pic: {
            url: "/oramaV1/imgs/rounded-in-photoretrica_1.png",
            style: { float: "right", padding: "40px" },
            className: "img-fluid",
            position: "left"
